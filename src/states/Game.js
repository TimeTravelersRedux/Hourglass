...
import { newPlayer, removePlayer, movePlayer } from '../reducer.js'
...
export default class extends Phaser.State {
  ...
  _spawnCharacters(data) {
    ...
    // console.log('initialPos', data.hero.x)
    store.dispatch(newPlayer(1, data.hero.x, data.hero.y))
    this.game.add.existing(this.hero)
  };
  ...
  _handleInput () {
    if (this.keys.left.isDown) { // move hero left
      this.hero.move(-1);
      // console.log('phaser pos', this.hero.position);
      // store.dispatch(movePlayer(0, this.hero.position.x, this.hero.position.y));
